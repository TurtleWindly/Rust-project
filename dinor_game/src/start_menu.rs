...
fn setup_start_animation(mut commands: Commands, windows: Query<&Window>) {
...
fn start_animation(mut commands: Commands, mut query: Query<(&mut Transform, Entity), With<Rectangle>>) {
